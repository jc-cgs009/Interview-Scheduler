...
class InterviewScheduler:
    ...
    def login_to_google(self):
        ...
        # gl.click_on_continue_as()

    def schedule_interview(self):
        path = r"D:\Documents\ScheduleInterviewSelenium\Utilities\interview_data.json"
    ...
    def update_scheduled_interview(self):
        path = r"D:\Documents\ScheduleInterviewSelenium\Utilities\update_interview_data.json"
        data = get_interview_data(path)
        self.login_to_google()
        uct = CalendarTask(self.driver, self.cal_url)
        uct.hit_calendar_url()
        uct.click_on_event_date(data['interview_scheduled_date'])
        # uct.clik_on_interview_scheduler_check_box()
        uct.click_on_event(data['title'])
        uct.click_on_edit()
        uct.add_title(data['title'])
    ...
    def cancel_scheduled_interview(self):
        path = r"D:\Documents\ScheduleInterviewSelenium\Utilities\cancel_interview_data.json"
        data = get_interview_data(path)
        self.login_to_google()
